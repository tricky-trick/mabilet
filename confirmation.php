...
if($_SERVER["REQUEST_METHOD"] == "GET")
{
	...
	if($count==1){
		...
		$message = "Вітаємо, $user_name. <br> Реєстрація на ресурсі maBilet пройшла успішно. Ваші дані: <br> Ім'я: $user_name <br> Прізвище: $user_sname <br> Пароль: $user_pwd <br> Телефон: $user_phone <br> 
					Місто: $user_city <br><br> З повагою, <br> Команда maBilet.";
